package edu.upc.tutorial.jaxrs.android;
...
import edu.upc.tutorial.jaxrs.android.data.LibraryClient;
import edu.upc.tutorial.jaxrs.android.data.LibraryResteasyClient;
...
public class LibraryApplication extends Application {
    ...
    public static String getRequestURI(Context context) {
        ...
        String requestURI = "http://" +  host + ":" + port + "/server/jaxrs-sample/library";
