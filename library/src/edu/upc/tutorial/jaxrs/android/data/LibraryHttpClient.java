 ...
 */
package edu.upc.tutorial.jaxrs.android.data;

import static edu.upc.tutorial.jaxrs.android.LibraryApplication.LOG_TAG;
...
import edu.upc.tutorial.jaxrs.android.R;
...
public class LibraryHttpClient implements LibraryClient {
    ...
    private URI getRequestURI(String path) throws URISyntaxException {
        ...
        URI requestURI = new URI("http://" +  host + ":" + port + "/server/jaxrs-sample/library/" + path);
